import sys
# sys.path.append('..')
from SeaM_main.src.multi_class.datasets.load_imagenet import load_imagenet_superclass
from SeaM_main.src.multi_class.datasets.load_cifar100 import load_cifar100_superclass
